...
def _build_content_disposition_header(
    *,
    ...
    filename = (display_name or fallback_name or "download").strip()
...
def upload_chat_files(
    ...
    for upload in files:
        file_type = mime_type_to_chat_file_type(upload.content_type)
    ...
    return ChatFileUploadResponse(files=descriptors)
...
def handle_send_chat_message(
    ...
    def stream_generator() -> Generator[str, None, None]:
        ...
        try:
            ...
            # Client disconnected or request cancelled while streaming.
