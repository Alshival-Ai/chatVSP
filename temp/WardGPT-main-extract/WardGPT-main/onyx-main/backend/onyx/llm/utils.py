...
def is_true_openai_model(model_provider: str, model_name: str) -> bool:
    ...
    # Azure provider always targets Azure OpenAI deployments and should use the
    # OpenAI responses API path even when deployment names are custom and do not
    # appear in LiteLLM's OpenAI model registry.
    if model_provider == LlmProviderNames.AZURE:
        return True
