...
ONYX_DEFAULT_APPLICATION_NAME = "WardGPT"
...
# Messages
DISABLED_GEN_AI_MSG = (
    "Your System Admin has disabled the Generative AI functionalities of WardGPT.\n"
    "Please contact them if you wish to have this enabled.\n"
    "You can still use WardGPT as a search engine."
)
...
class OnyxCeleryTask:
    ...
    ROTATE_LOCAL_MCP_API_KEY = "rotate_local_mcp_api_key"
    SYNC_LOCAL_MCP_TOOLS = "sync_local_mcp_tools"
