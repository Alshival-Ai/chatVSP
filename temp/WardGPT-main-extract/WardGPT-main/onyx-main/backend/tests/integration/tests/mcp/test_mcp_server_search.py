...
MCP_GOOGLE_PLACES_TEXT_TOOL = "google_places_search_text"
MCP_GOOGLE_PLACES_GEOCODE_TOOL = "google_places_geocode_address"
MCP_GOOGLE_PLACES_DETAILS_TOOL = "google_places_get_place_details"
MCP_GOOGLE_PLACES_NEARBY_TOOL = "google_places_search_nearby"
MCP_KMZ_PACKET_EXTRACT_TOOL = "extract_kmz_packet_from_base64"
...
def test_mcp_document_search_flow(
    ...
    assert MCP_GOOGLE_PLACES_TEXT_TOOL in tool_names
    assert MCP_GOOGLE_PLACES_GEOCODE_TOOL in tool_names
    assert MCP_GOOGLE_PLACES_DETAILS_TOOL in tool_names
    assert MCP_GOOGLE_PLACES_NEARBY_TOOL in tool_names
    assert MCP_KMZ_PACKET_EXTRACT_TOOL in tool_names
