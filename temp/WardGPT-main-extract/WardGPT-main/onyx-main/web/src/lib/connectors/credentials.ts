...
export const credentialTemplates: Record<ValidSources, any> = {
  ...
  sharepoint: {
    ...
    authMethods: [
      {
        value: "oauth_interactive",
        label: "OAuth (Delegated)",
        fields: {},
        description:
          "Use delegated Microsoft Graph permissions via OAuth authorization.",
        disablePermSync: true,
      },
      {
        value: "microsoft_graph_backend",
        label: "Microsoft Graph Backend",
        fields: {},
        description:
          "Use the backend Microsoft Graph app credentials (OAUTH_CLIENT_ID, OAUTH_CLIENT_SECRET, OAUTH_MICROSOFT_TENANT_ID).",
        disablePermSync: true,
      },
      {
        value: "client_secret",
  ...
  imap: {
    ...
    authMethods: [
      {
        value: "oauth_interactive",
        label: "OAuth (Microsoft Graph)",
        fields: {},
        description:
          "Use your Microsoft delegated permissions to index Outlook mailbox data.",
        disablePermSync: true,
      },
      {
        value: "basic",
        label: "IMAP Username/Password",
        fields: {
          imap_username: "",
          imap_password: "",
        },
        description:
          "Use direct IMAP login credentials for mailbox access.",
        disablePermSync: true,
      },
    ],
  } as CredentialTemplateWithAuth<ImapCredentialJson>,
  testrail: {
    testrail_base_url: "",
    testrail_username: "",
    testrail_api_key: "",
