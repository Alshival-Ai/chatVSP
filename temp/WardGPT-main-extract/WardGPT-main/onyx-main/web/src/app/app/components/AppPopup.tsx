...
const WardLogoHeaderIcon = ({ className, size = 24 }: IconProps) => (
  <img
    src="/logo.png"
    alt="WardGPT"
    style={{
...
export function AppPopup() {
  ...
  // Header icon rules:
  // - If neither app name nor custom logo exists -> show WardGPT logo
  // - If logo display is "name_only" -> show alert icon
  // - Otherwise -> show uploaded custom logo (fallback to WardGPT logo)
  const headerIcon =
  ...
  return (
    <Modal open onOpenChange={() => {}}>
      <Modal.Content width="sm" height="lg">
        <Modal.Header
          icon={headerIcon}
          title={popupTitle || "Welcome to WardGPT!"}
        />
        <Modal.Body>
