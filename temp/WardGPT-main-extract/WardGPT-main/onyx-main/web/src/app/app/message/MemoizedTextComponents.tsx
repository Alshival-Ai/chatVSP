...
export const MemoizedLink = memo(
  ({
    ...
    // Render backend chat file links as an explicit download action.
    ...
    if (isChatFile) {
      ...
      return (
        <a
          href={url}
          download
          className="inline-flex items-center gap-1 rounded-08 border border-border px-2 py-1 text-sm font-medium text-link hover:bg-background-subtle"
