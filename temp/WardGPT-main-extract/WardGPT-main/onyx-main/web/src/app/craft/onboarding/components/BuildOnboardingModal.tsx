...
function getStepsForMode(
  ...
  switch (mode.type) {
    case "initial-onboarding":
      // Full flow: page1 → llm-setup (if admin + no providers) → user-info
      const steps: OnboardingStep[] = ["page1"];

      // Only require LLM setup if no providers exist at all.
      // If any provider exists, Craft can use workspace defaults.
