...
import { PreviewWindowState, type PreviewSnapZone } from "@/app/codex-labs/types";
...
interface CodexLabsPreviewWindowsProps {
...
const CONTENT_API_PREFIX = "/api/codex-labs/files/content";
...
export default function CodexLabsPreviewWindows({
  windows,
  workspaceBounds,
  onCloseWindow,
  onFocusWindow,
