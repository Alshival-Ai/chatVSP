  ...
  return (
    <div className="mb-8">
      <p className="mb-2 text-sm text-muted-foreground">
        Setup Slack bots that connect to WardGPT. Once setup, you will be able to
        ask questions to WardGPT directly from Slack. Additionally, you can:
      </p>

      <div className="mb-2">
        <ul className="list-disc mt-2 ml-4 text-sm text-muted-foreground">
          <li>
            Setup WardGPTBot to automatically answer questions in certain channels.
          </li>
          <li>
            Choose which document sets WardGPTBot should answer from, depending on
            the channel the question is being asked.
          </li>
          <li>
            Directly message WardGPTBot to search just as you would in the web UI.
          </li>
        </ul>
      </div>
      ...
      <p className="mb-6 text-sm text-muted-foreground">
        ...
        found in the WardGPT documentation to get started!
      </p>
