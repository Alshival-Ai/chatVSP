      ...
      {hasProcessingFiles && (
        <GeneralLayouts.Section height="auto" alignItems="start">
          <Text as="p" text03 secondaryBody>
            WardGPT is still processing your uploaded files. You can create the
  ...
  return (
    <TableLayouts.TwoColumnLayout minHeight={18.75}>
      <KnowledgeSidebar
        ...
        allowFileKnowledge={allowFileKnowledge}
      ...
      <TableLayouts.ContentColumn>
        ...
        {allowFileKnowledge && activeView === "recent" && (
...
const KnowledgeMainContent = memo(function KnowledgeMainContent({
  ...
  const totalSelected =
    ...
    (allowFileKnowledge ? selectedFileIds.length : 0) +
...
interface AgentKnowledgePaneProps {
  ...
  // When false, disables file uploads and file-based knowledge selection.
  allowFileKnowledge?: boolean;
...
export default function AgentKnowledgePane({
  ...
  useEffect(() => {
    if (!allowFileKnowledge && view === "recent") {
      setView("main");
    }
  }, [allowFileKnowledge, view]);
