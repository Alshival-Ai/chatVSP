...
export function FileCard({
  ...
  // Lightweight mode while files are still uploading/processing:
  // render a text-only card to avoid image preview fetch/render churn.
  ...
  // For completed images, show the larger preview layout.
  if (isImage) {
    return (
      <ImageFileCard
        file={file}
