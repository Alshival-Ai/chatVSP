...
import ToggleOnyxCraftButton from "./buttons/ToggleOnyxCraftButton";
import ToggleCodeInterpreterButton from "./buttons/ToggleCodeInterpreterButton";
import ToggleCodexLabsButton from "./buttons/ToggleCodexLabsButton";
          ...
          <div className="grid gap-1">
            {NEXT_PUBLIC_CLOUD_ENABLED && user.id === currentUser?.id ? (
              ...
              <>
                ...
                <ToggleCodeInterpreterButton
                  user={user}
                  mutate={refresh}
                  className={buttonClassName}
                />
                <ToggleOnyxCraftButton
                  user={user}
                  mutate={refresh}
                  className={buttonClassName}
                />
                <ToggleCodexLabsButton
                  user={user}
                  mutate={refresh}
                  className={buttonClassName}
                />
