...
- browser UI for:
  ...
  - app-level textarea styling is now scoped away from Monaco's hidden `.inputarea`, which prevents the editor's internal keyboard textarea from rendering as a visible box above the main editing surface
