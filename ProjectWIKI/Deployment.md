...
- browser UI for:
  ...
  - the desktop text editor now scopes a textarea override to the Monaco host itself, which keeps Monaco's internal keyboard textarea hidden and prevents it from rendering as a visible box above the main editing surface
