...
- browser UI for:
  ...
  - the desktop text editor now scopes overrides for Monaco's internal edit surfaces to the Monaco host itself, which keeps those hidden keyboard-capture elements from rendering as visible boxes above the main editing surface
