...
- browser UI for:
  ...
  - app-level textarea styling is now scoped away from Monaco's hidden `.inputarea`, and a matching high-specificity override reapplies Monaco's hidden-input layout so the editor's internal keyboard textarea does not render as a visible box above the main editing surface
