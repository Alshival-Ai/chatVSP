...
- Current live scope includes:
  ...
  - modular web UI with:
    ...
    - Neural Apps currently includes a Text Editor that opens as its own floating app window over the workspace and can save pasted text directly into the workspace as a file
