...
- Frontend window model:
  ...
  - the desktop window workspace spans under the pinned top header overlay, so snapped/maximized windows can occupy the full top edge of the desktop while the header remains clickable above them
