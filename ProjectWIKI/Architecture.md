...
- Frontend window model:
  ...
  - the app's global textarea styling is explicitly scoped away from Monaco's hidden `.inputarea`, so Monaco's keyboard-capture textarea remains invisible instead of leaking into the visible editor layout
