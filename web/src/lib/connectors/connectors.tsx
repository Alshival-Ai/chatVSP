  ...
  google_drive: {
    ...
    advanced_values: [
      ...
      },
      {
        ...
        description:
          "When enabled, ChatVSP skips files that are shared broadly (domain or public) but require the link to access.",
...
• Specifying sites currently works for SharePoint instances using English, Spanish, or German. Contact the ChatVSP team if you need another language supported.
`,
      },
    ],
    advanced_values: [
