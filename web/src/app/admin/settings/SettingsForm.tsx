  ...
  return (
    <>
      ...
      <Checkbox
        ...
        sublabel="If set, users will not be required to sign in to use ChatVSP."
          ...
          <Modal.Content>
            ...
            <Modal.Body>
              <p>
                ...
                anyone to use ChatVSP without signing in.
              </p>
            </Modal.Body>
            <Modal.Footer>
      ...
      {isEnterpriseEnabled && (
        <>
          ...
          <IntegerInput
            ...
            sublabel="Enter the maximum number of days you would like ChatVSP to retain chat messages. Leaving this field empty will cause ChatVSP to never delete chat messages."
