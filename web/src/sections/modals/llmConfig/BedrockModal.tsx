      ...
      <FieldWrapper>
        <Section gap={1}>
          ...
          <InputLayouts.Vertical
            ...
            subDescription="Choose how chatVSP should authenticate with Bedrock."
          >
            <InputSelect
      ...
      {authMethod === AUTH_METHOD_IAM && (
        <FieldWrapper>
          <Card backgroundVariant="none" borderVariant="solid">
            <Content
              icon={SvgAlertCircle}
              title="chatVSP will use the IAM role attached to the environment it’s running in to authenticate."
              variant="body"
              sizePreset="main-ui"
            />
          </Card>
