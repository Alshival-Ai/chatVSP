...
const BASE_PATH = (process.env.NEXT_PUBLIC_NEURAL_LABS_BASE_PATH || "").replace(/\/+$/, "");
const VSCODE_BASE_PATH = `${BASE_PATH}/vscode`;
...
function sendUnauthorized(res) {
  res.statusCode = 302;
  res.setHeader("location", `${BASE_PATH}/login`);
